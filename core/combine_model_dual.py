...
class CombineModel(nn.Module):
    ...
    def forward(self, left_hdr, right_hdr, left_next_hdr, right_next_hdr, 
        ...
        device = next(self.disp_recon_net.parameters()).device
        ...
        #^ Exposure control
        if getattr(self.args, "disable_adec", False):
            exp1, exp2 = initial_exp_high, initial_exp_low
        else:
            exp1, exp2 = stereo_exposure_control(
                initial_exp_high,
                initial_exp_low,
                histo_ldr1,
                histo_ldr2,
                alpha1=self.alpha_values,
                alpha2=self.alpha_values,
